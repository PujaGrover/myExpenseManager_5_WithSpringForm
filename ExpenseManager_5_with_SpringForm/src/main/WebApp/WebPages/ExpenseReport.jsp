	...
	<main>
		<div class="main-container">
			<div>
				...
				<h6>Please select month and year to see the expense transactions</h6>
			</div>
			<div></div>
			<div class="form-container" align="center">
				<form action="${pageContext.request.contextPath}/showExpenseReport"
					method="get"  >
					<div align="center">
						<div class="form-group">
							...
							<label for="year">Year</label> <span>&nbsp;</span> <select
				...
				<div>
					...
					<hr>
					<caption>
						<h5 style="text-align: center;">List Of All Expense
					...
					<table class="table table-hover ">
						...
						<c:forEach items="${allExpensesByYearAndMonth}" var="expense">
							<tr class="table-light">
								<td>${expense.expenseDate.plusDays(1)}</td>
					...
					<div>
						<hr>
						<br> <label for="totalExpense">Total Expense</label> <span>&nbsp;</span>
